		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header with-border">
					<h3 class="box-title">{!! trans('form.form_create', ['name'=>'Slider']) !!}</h3>
				</div>
				{!! Form::model($slider, [
				'method' => 'PATCH',
				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-4 col-xs-12">
							<div id="hide">
								{!! Html::image('images/slider/'.$slider->image,'',["style"=>"width:100%;"]) !!}
							</div>
				...
				<div class="box-footer">
					<div class="col-sm-offset-5">
						...
						<a href="{!! route('admin.slider.index') !!}" class="btn btn-default">{!! 'Cancel' !!}</a>
					</div>
				</div>
				{!! Form::close() !!}
			</div>
